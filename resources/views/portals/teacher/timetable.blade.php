<x-layouts.app title="My timetable">
    <x-ui.page-header title="My timetable" description="Your weekly teaching schedule." />

    @if ($entriesByDay->isEmpty())
        <x-ui.card>
            <x-ui.empty-state icon="◷" title="No timetable yet" description="Your schedule appears here once it is published." />
        </x-ui.card>
    @else
